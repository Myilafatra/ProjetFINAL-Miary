...
import GetAtelier from "./components/propAtelier/propAtelier"
...
import Footer from "./components/design/menu/Footer"
        ...
        <Router>
          ...
          <Route exact path="/Particulier" component={Menu} />
            ...
            <Switch>
              ...
              <PrivateRoute exact path="/dashboard/tabatelier" component={GetAtelier} />
            </Switch>
            <Footer/>
          </div>
        </Router>
